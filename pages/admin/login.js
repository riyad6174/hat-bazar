...
export default function AdminLogin() {
  ...
  return (
    <>
      <Head>
        <title>Admin Login | Hat Bazar</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Hat Bazar Admin</h1>
            <p className="text-sm text-gray-500 mt-1">Sign in to manage orders & products</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="admin@hatbazar.com"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-2.5 rounded-lg font-semibold text-sm hover:bg-slate-800 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
